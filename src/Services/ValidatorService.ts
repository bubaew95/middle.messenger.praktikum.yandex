...
{ 
    ...
    static validate(validator: ValidatorInterface, value: string, component: Block): boolean 
    {
    ...
    protected static isEmplty(validator: ValidatorInterface, component: Block): boolean
    {
        if(validator.empty()) {
            component.setProps({
    ...
    protected static isValidate(validator: ValidatorInterface, component: Block): boolean
    {
